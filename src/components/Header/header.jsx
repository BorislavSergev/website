...
const Header = () => {
  ...
  return (
    <>
          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center">
              <a className="block text-teal-400" href="#">
                ...
                <svg
                  className="h-8 w-8" // Explicitly set width and height
                  viewBox="0 0 28 24"
                  fill="none"
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="block md:hidden">
                <button
                  ...
                  className="rounded bg-gray-700 p-2 text-gray-300 transition hover:text-gray-400"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-6 w-6"
      ...
      {/* Mobile Drawer */}
      <div
        className={`fixed inset-y-0 right-0 z-50 w-64 bg-[#111111] text-white shadow-lg transform transition-transform duration-300 ease-in-out ${
